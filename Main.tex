...
\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.5983}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.1966}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.1966}}@{}}
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
...
\item
  \$\text{Transaction Costs} \uparrow \therefore D\_M \downarrow \$
\item
