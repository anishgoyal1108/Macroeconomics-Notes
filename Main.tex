...
Where \(P_c\) is the current price, \(P_{c,\text{base}}\) is the base
year price, and \(Q_b\) is the quantity of the good/service.
...
\subsection{The Business Cycle}\label{the-business-cycle}
...
\subsection{Who Is Hurt/Benefits from (Unanticipated)
...
\subsubsection{How to know who is hurt/helped by
inflation}\label{how-to-know-who-is-hurthelped-by-inflation}
...
\tightlist
\item
  \textbf{Borrowers/Debtors} are hurt because they have to pay back a
  higher interest
\item
  \textbf{Savers/Lenders/Creditors} are helped because they receive more
  than the actual interest
\end{itemize}
...
\subsubsection{Who is hurt by
inflation?}\label{who-is-hurt-by-inflation}

\subsubsection{Who benefits from
inflation?}\label{who-benefits-from-inflation}
